...
create table intu (date varchar(255), open_price float, high_price float, low_price float, close_price float, adj_close_price float, volume float)
bulk insert intu from '/Historical_Data/INTU.csv' with (format='CSV', firstrow=2, fieldterminator=',', rowterminator='\n')
